...
public:
  ...
  MainContentComponent() : conn(),
                           effects{}
    {
        ...
        delayLength.setRange(0.0, 1.0);
        delayLength.addListener(delay.get());

        addAndMakeVisible(delayLengthLabel);
        delayLengthLabel.setText("Length", dontSendNotification);
        delayLengthLabel.attachToComponent(&delayLength, true);
    ...
    void resized() override
    {
        ...
        delayLength.setBounds (sliderLeft, 20, getWidth() - sliderLeft - 10, 20);
    }
